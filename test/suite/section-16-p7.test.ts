// TEST-SPEC §16 P-7 (PROP-05): thin Vitest wrapper over the registered
...
import { section16P7Tests } from "./registry/section-16-p7.js";

declareProductTests(section16P7Tests);
