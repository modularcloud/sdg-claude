...
* **The remaining negative matrices and refusals (2.1 import negatives, 2.4, 2.7, 4.x imports and markers, 5.3 cycles, 6.3 baseline failures, 6.4/6.5 refusals, 7.x configuration validation, 10.1 session-name and non-session negatives, 12.0 usage errors, and the masking and reporter-matrix contracts of 14 — T14-3, T14-4)** and the remaining absence-of-effect sweeps (T12.0-11, T12.1-4, T13.3-3): they share the double-invalidity, error-identity and masking, and compare-around structures certified representatively through CONF-VALID and VIOL-CORE-CHATTYREADS; certifying each would be completeness, which this document must not pursue.
