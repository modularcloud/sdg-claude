...
- [`.claude/prompts/liaison-mode.md`](.claude/prompts/liaison-mode.md) — how much judgment Liaison exercises on your behalf: **CTO** (default — makes the technical choices, surfaces only product questions) or **Project Manager** (defers major technical choices to you), or write your own mode. Switch by editing the file or just telling it in chat.
