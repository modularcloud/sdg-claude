...
Your information scope is exactly: your mission file, the PROCESS.md sections it names, the target (with all of its modules), and the bundle files listed in your spawn prompt — nothing else. Write your full review to `specs/tmp/REVIEW.md` (create or overwrite) in the format below.
